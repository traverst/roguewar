...
class DungeonGenerator {
    ...
    generate() {
        ...
        for (let i = 0; i < maxRooms; i++) {
            const w = (0, rng_1.randomInt)(this.rng, minSize, maxSize);
            const h = (0, rng_1.randomInt)(this.rng, minSize, maxSize);
            const x = (0, rng_1.randomInt)(this.rng, 1, this.width - w - 1);
            const y = (0, rng_1.randomInt)(this.rng, 1, this.height - h - 1);
            ...
            if (!failed) {
                ...
                if (this.rooms.length > 0) {
                    ...
                    if ((0, rng_1.randomInt)(this.rng, 0, 2) === 1) {
