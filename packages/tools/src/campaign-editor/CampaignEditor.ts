...
export class CampaignEditor {
        ...
        if (this.activeSidebarTab === 'flow') {
            ...
            tabContent = `
                <div class="btn-group" style="flex-direction: column; width: 100%;">
                    <button class="btn btn-success" id="btn-export">Export Campaign</button>
                    <button class="btn btn-secondary" id="btn-import">Import Campaign</button>
    ...
    private exportCampaign(): void {
        ...
        const messagesDiv = document.getElementById('validation-messages')!;
        messagesDiv.innerHTML = '<div class="validation-warning">✅ Campaign exported successfully!</div>';
    }
