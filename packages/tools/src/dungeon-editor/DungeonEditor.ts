...
export class DungeonEditor {
        ...
        if (this.activeSidebarTab === 'structure') {
            ...
            tabContent = `
                <div class="btn-group" style="flex-direction: column; width: 100%;">
                    <button class="btn btn-success" id="btn-export">Export Dungeon</button>
                    <button class="btn btn-secondary" id="btn-import">Import Dungeon</button>
    ...
    private exportDungeon(): void {
        ...
        const messagesDiv = document.getElementById('validation-messages')!;
        messagesDiv.innerHTML = '<div class="validation-warning">✅ Dungeon exported successfully!</div>';
    }
