...
export class EntityEditor {
                ...
                <div class="editor-sidebar">
                    ...
                    <div class="panel">
                        ...
                        <div class="btn-group" style="flex-direction: column; width: 100%;">
                            <button class="btn btn-success" id="btn-export">Export Template</button>
                            <button class="btn btn-secondary" id="btn-import">Import Template</button>
    ...
    private exportEntity(): void {
        ...
        messagesDiv.innerHTML += '<div class="validation-warning">✅ Entity template exported successfully!</div>';
    }
